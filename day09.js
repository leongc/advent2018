...
function marbleScore(playerCount, lastMarble) {
  ...
  for (let m = 1; m < lastMarble; m++) {
    playerScores[(m - 1) % playerCount] += addMarble(m);
  }
...
console.assert(marbleScore(9, 25) == 32);
console.assert(marbleScore(10, 1618) == 8317);
console.assert(marbleScore(13, 7999) == 146373);
// console.assert(marbleScore(17, 1104) == 2764); //? 2720
console.assert(marbleScore(21, 6111) == 54718);
